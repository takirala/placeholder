module github.com/nutanix-cloud-native/nkp-nutanix-product-catalog/apptests

go 1.24.2

require github.com/fluxcd/source-controller/api v1.5.0
...
require (
	...
	github.com/fluxcd/kustomize-controller/api v1.5.0 // indirect
	...
	github.com/traefik/traefik/v2 v2.11.22 // indirect
